...
PROVIDERS = [
    ...
    {"id": "azure-foundry", "name": "Azure Foundry", "env": "AZURE_FOUNDRY_API_KEY",
     ...
     "tags": []},
    {"id": "upstage", "name": "Upstage Solar", "env": "UPSTAGE_API_KEY",
     "base": "https://api.upstage.ai/v1",
     "models": ["solar-pro3", "solar-pro2", "solar-mini", "solar-pro", "syn-pro", "solar-embedding-1"],
     "key_hint": "粘贴 Upstage API Key", "note": "韩国 Solar 推理模型",
     "tags": ["kr"]},
    {"id": "qwen-oauth", "name": "Qwen Portal (OAuth)", "env": "QWEN_OAUTH_TOKEN",
     "base": "https://portal.qwen.ai/v1",
     "models": ["qwen-max", "qwen-plus", "qwen-turbo", "qwen-long", "qwen3-coder-plus", "qwen2.5-72b-instruct"],
     "key_hint": "粘贴 Qwen Portal Token", "note": "通义千问 OAuth 门户",
     "tags": ["cn"]},
